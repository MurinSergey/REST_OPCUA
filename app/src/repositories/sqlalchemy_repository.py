...
from ..models.models_type import SqlAlchemyModelType, CreateSchemaType, UpdateSchemaType

class SqlAlchemyRepository(IAbstractDbRepository, Generic[SqlAlchemyModelType, CreateSchemaType, UpdateSchemaType]):
        ...
        async def get_all(self) -> list[SqlAlchemyModelType]:
        ...
        async def update(self, data: UpdateSchemaType, **filters) -> SqlAlchemyModelType:
            async with self._session_factory() as session:
        ...
        async def delete(self, **filters) -> SqlAlchemyModelType | None:
            async with self._session_factory() as session:
